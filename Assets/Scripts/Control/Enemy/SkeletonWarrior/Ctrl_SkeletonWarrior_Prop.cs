...
namespace Control {
	...
	public class Ctrl_SkeletonWarrior_Prop : Ctrl_BaseEnemy_Prop {
		...
		public int IntMaxHP = 40;						//敌人的最大生命值
		public int IntATK = 12;							//敌人的攻击力
		public int IntDEF = 4;							//敌人的防御力

		public float FloAtkSpeed = 3f;					//敌人的攻击速度

		public float FloMoveSpeed = 4f;					//敌人移动速度
		public float FloRotationSpeed = 1f;				//敌人转身速度
		public float FloAlertDistance = 10f;			//敌人的警戒距离
		public float FloAttackDistance = 2f;			//敌人发起攻击的最小距离

		public int IntEnemyEXP = 8;						//敌人死亡时，主角获得的的经验值
		public int IntEnemyGold = 15;					//敌人死亡时，主角获得的金钱
