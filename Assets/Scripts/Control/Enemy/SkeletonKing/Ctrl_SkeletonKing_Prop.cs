...
namespace Control {
	...
	public class Ctrl_SkeletonKing_Prop : Ctrl_BaseEnemy_Prop {

		/* 在这里修改敌人的真实属性 */

		public int IntMaxHP = 200;                       //敌人的最大生命值
		public int IntATK = 30;                         //敌人的攻击力
		public int IntDEF = 6;                          //敌人的防御力

		public float FloAtkSpeed = 8f;                  //敌人的攻击速度

		public float FloMoveSpeed = 6f;                 //敌人移动速度
		public float FloRotationSpeed = 1f;             //敌人转身速度
		public float FloAlertDistance = 15f;            //敌人的警戒距离
		public float FloAttackDistance = 4f;            //敌人发起攻击的最小距离

		public int IntEnemyEXP = 30;                     //敌人死亡时，主角获得的的经验值
		public int IntEnemyGold = 50;                   //敌人死亡时，主角获得的金钱
